...
if (isset($_POST["sbmtForgot"])){
     ...
     $url = "http://localhost/Market/admin/outerlogin/reset/securityReset.php?selector=" . $selector . "&validator=" . bin2hex($token);
     ...
     $to = $usrEmail;
     $subject = "Reset your password for Market.com";
     ...
     $headers = "From: Market Place management <marketordering69@gmail>\r\n";
     $headers .= "Reply-To: marketordering69@gmail\r\n";
