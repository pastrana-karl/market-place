...
mysqli_report(MYSQLI_REPORT_ERROR | MYSQLI_REPORT_STRICT);
    ...
    if(isset($_POST['action']) && isset($_POST['action']) == 'order')
    {
        ...
        $sql = 'INSERT INTO tbl_orders (name, email, phonenumber, address, city, region, order_items, paymentmode, order_date, grand_total, order_status) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);';
        ...
        if(!mysqli_stmt_prepare($stmt, $sql))
        {
         ...
         mysqli_stmt_bind_param($stmt, 'ssssssssssss', $name, $email, $phone, $address, $city, $region, $products, $pmode, $order_date, $grand_total, $order_status);
